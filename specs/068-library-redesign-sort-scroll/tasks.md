...
- [X] T066 [US4] Run `cd frontend && npx vitest run tests/unit/ViewModeToggle.test.tsx tests/unit/LibraryToolbar.test.tsx` and `cd e2e && npm test -- tests/library-toolbar.spec.ts` until green — owner: qa-agent
