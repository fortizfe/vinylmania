/**
 * Fixed, curated list of Discogs style names (spec FR-008, feature 038).
 * No Discogs endpoint enumerates valid style values, so this list is
 * maintained statically. Declaration order is the canonical order used
 * everywhere a style selection is serialized or rendered (URL params,
